...
<script>
	...
	function product_write() {
		...
		var product_name = document.form1.product_name.value; // html페이지에 있는 form1에 있는 상품이름을 반환해서 name에 저장함
		var price = document.form1.price.value; // html페이지에 있는 form1에 있는 상품의 값을 반환해서 price에 저장함
		var description = document.form1.description.value; // html페이지에 있는 form1에 있는 상품의 정보를 반환해서 description에 저장함
		//document는 웹 페이지에 접근한다는 뜻
