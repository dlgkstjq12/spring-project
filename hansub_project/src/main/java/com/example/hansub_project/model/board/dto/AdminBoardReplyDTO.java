...
public class AdminBoardReplyDTO {
	...
	public String toString() {
		return "AdminBoardReplyDTO [rno=" + rno + ", bno=" + bno + ", r_content=" + r_content + ", user_id=" + user_id
				+ ", reg_date=" + reg_date + ", join_date=" + join_date + ", recommend=" + recommend + "]";
	}
